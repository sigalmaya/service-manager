...
func CatalogFetcher(doRequestOsbFunc util.DoRequestOsbFunc, brokerAPIVersion string) func(ctx context.Context, broker *types.ServiceBroker) ([]byte, error) {
	return func(ctx context.Context, broker *types.ServiceBroker) ([]byte, error) {
		...
		request := util.AuthAndTlsDecorator(tlsConfig, broker.Credentials.Basic.Username, broker.Credentials.Basic.Password, doRequestOsbFunc)
